  ...
  <body>
    <header>
      ...
      <nav>
        ...
        <div class="nav-item">
          <a href="pages/berlin-sport.php"><h3>Berlin-sport</h3></a>
        </div>
        <div class="nav-item">
          <a href="pages/kultur.php"><h3>Kultur Und Show</h3></a>
        </div>
        <?php
      if(isset($_SESSION["username"]) && $_SESSION["permission"]==1){
        echo '<div class="nav-item">';
        echo '  <a href="pages/administracija.php"><h3>Administracija</h3></a>';
        echo '</div>';
        echo '<div class="nav-item">';
        echo '  <a href="pages/unos.php"><h3>Unos</h3></a>';
        echo '</div>';
      }
      ?>
      <?php
      if(!isset($_SESSION["username"])){
        echo '<div class="nav-item">';
        echo '  <a href="pages/login.php"><h3>Log in</h3></a>';
        echo '</div>';
      }
      ?>
        <div class="nav-item hoverShow">
        <h3>Categories</h3>
          <form class="dropdown-content" method="POST" action="pages/kategorije.php">
    ...
    <main id="welcome-news-container">
      <?php
      showArticles(3,999,"Sport",0);
      showArticles(2,999,"ShowBizz",0);
      showArticles(1,999,"Politics",0);
      showArticles(4,999,"Other",0);
      ?>
    </main>
    <footer>
      <section>
