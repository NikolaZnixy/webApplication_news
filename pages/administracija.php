  ...
  <header>
    ...
    <main id="welcome-news-container">
      ...
      if (isset($_GET['message'])) {
        echo '<div id="success-message">' . htmlspecialchars($_GET['message']) . '</div>';
        }
      showArticles(1,999,"Politics",1);
      showArticles(2,999,"ShowBizz",1);
      showArticles(3,999,"Sport",1);
      showArticles(4,999,"Other",1);
      ?>
    </main>
    <footer>
      <section>
    ...
    <script>
        ...
        setTimeout(function(){hide(successDiv);}, 5000);
